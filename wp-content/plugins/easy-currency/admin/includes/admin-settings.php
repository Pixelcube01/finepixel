...
class ECCW_admin_settings
{
    ...
    public function get_eccw_settings_options_tab_fields()
    {
        ...
        if ( class_exists( 'Polylang' ) ) {
            ...
            $switcher_polylang_sec_start = array(
                array(
                    'type' => 'html',
                    'html' => '<div class="eccw-polylang-switcher">'
                )
            );

            // PRO version label message instead of notice
            $switcher_polylang_notice = array(
                'switcher_polylang_title' => array(
                    'name' => __('Polylang ', 'easy-currency'),
                    'type' => 'title',
                    'desc' => '',
                    'id' => 'eccw_settings_switcher_polylang_title'
                ),
                'polylang_pro_label' => array(
                    'title' => __( 'Polylang Switcher', 'easy-currency' ),
                    'id'    => 'advanced_settings[eccw_polylang_switcher_enable]',
                    'type'  => 'switcher',
                    'default' => isset($advanced_settings['eccw_polylang_switcher_enable']) ? $advanced_settings['eccw_polylang_switcher_enable'] : 'no',
                    'class' => 'eccw-switcher-ui-control-show-hide',
                    'eccw_pro' => true,
                    'desc_tip' => true,
                    'description' => __('Enable this option Polylang Switcher Currency Convert', 'easy-currency'),
                ),
                'product_polylang_section_end' => array(
                    'type' => 'sectionend',
                    'id' => 'eccw_settings_polylang_section_end'
                )
            );
            $switcher_polylang_sec_end = array(
                array(
                    'type' => 'html',
                    'html' => '</div>'
                )
            ...
            $switcher_polylang_sec_start = $switcher_polylang_notice = $switcher_polylang_sec_end = array();
        }

        if ( is_plugin_active( 'sitepress-multilingual-cms/sitepress.php' ) ) {

            $switcher_wpml_sec_start = array(
                array(
                    'type' => 'html',
                    'html' => '<div class="eccw-wpml-switcher">'
                )
            );

            // PRO version label message instead of notice
            $switcher_wpml_notice = array(
                'switcher_wpml_title' => array(
                    'name' => __('Wpml Languages ', 'easy-currency'),
                    'type' => 'title',
                    'desc' => '',
                    'id' => 'eccw_settings_switcher_polylang_title'
                ),
                'wpml_pro_label' => array(
                    'title' => __( 'WPML Switcher', 'easy-currency' ),
                    'id'    => 'advanced_settings[eccw_wpml_switcher_enable]',
                    'type'  => 'switcher',
                    'default' => isset($advanced_settings['eccw_wpml_switcher_enable']) ? $advanced_settings['eccw_wpml_switcher_enable'] : 'no',
                    'class' => 'eccw-switcher-ui-control-show-hide',
                    'eccw_pro' => true,
                    'desc_tip' => true,
                    'description' => __('Enable this option WPML Switcher Currency Convert', 'easy-currency'),
                ),
                'product_wpml_section_end' => array(
                    'type' => 'sectionend',
                    'id' => 'eccw_settings_wpml_section_end'
                )
            );
            $switcher_wpml_sec_end = array(
                array(
                    'type' => 'html',
                    'html' => '</div>'
                )
            ...
            $switcher_wpml_sec_start = $switcher_wpml_notice = $switcher_wpml_sec_end = array();
        }

        $all_settings = array_merge(
            $eccw_global_options_settings,
            $switcher_location_start,
            $single_settings,
            $switcher_location_end,
            $switcher_polylang_sec_start,
            $switcher_polylang_notice,
            $switcher_polylang_sec_end,
            $switcher_wpml_sec_start,
            $switcher_wpml_notice,
            $switcher_wpml_sec_end
        );
