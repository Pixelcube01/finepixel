...
**Multiple Currency Switcher Elementor Widgets**

Add the WooCommerce multi-currency switcher to any section of your store with powerful Elementor widgets and shortcode support..

**Multiple Currency Switcher Dropdown Gutenberg Block**

The currency switcher dropdown is fully compatible with the Gutenberg block editor, ensuring smooth and seamless integration.
...
* **Multilingual support** You can select which currency to use for each language. Currently, WPML and Polylang are supported.
...
= 1.1.0 =
* Added: Currency switcher dropdown gutenberg block added.
* Fixed: Product Single Switcher on/off issue Fixed.
* Fixed: Currency switcher dropdown Elementor widgets Issue Fixed.

= 1.0.10 =
- Fixed: Shipping methods price change based on selected currency.

= 1.0.9 =
* Fixed: Side Switcher background &  color option fix
