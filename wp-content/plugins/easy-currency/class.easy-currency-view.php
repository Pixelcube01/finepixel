...
class ECCW_CURRENCY_VIEW  extends ECCW_CURRENCY_SWITCHER { 
    ...
    public function __construct(){
        ...
        $this->single_shortcode_onoff = 
            ( isset( $options['eccw_show_hide_single_product_location'] ) 
            && $options['eccw_show_hide_single_product_location'] === 'yes' )
            ? 1 
            : 0;
    ...
    public function eccw_set_cookie($name, $value, $duration_days) {
        $expiryTime = time() + ($duration_days * 24 * 60 * 60); 
