...
<?php
    ...
    $imgLink_src = wp_get_attachment_image_src($featID, 'large');
    $imgLink = ($imgLink_src && isset($imgLink_src[0])) ? $imgLink_src[0] : '';
                            ...
                            <div class="col-lg-3 col-md-3 col-sm-3 hidden-m">
                                ...
                                <div class="swiper-wrapper">
                                    ...
                                    foreach( $all_img as $pimage ){
                                        $link_src = wp_get_attachment_image_src($pimage, 'large');
                                        if( $link_src && isset($link_src[0]) ){
                                            $link = $link_src[0];
                                        ?>
