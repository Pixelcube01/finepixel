                        ...
                        <div class="col-lg-3">
                            <div class="psubcat-single d-flex flex-column justify-content-between">
                                <div class="info-content">
                                    ...
                                    <h4 class="pcat-titlle"><?php echo esc_html($name); ?></h4>
                                    <ul class="subcat-list">
                                        <?php 
                                        if ( $children && !is_wp_error($children) ) { 
                                            foreach( $children as $subcat ){
                                                if ( $subcat && ! is_wp_error( $subcat ) && is_object($subcat) && isset($subcat->taxonomy) && isset($subcat->name) ) {
                                                    $subcat_link = get_term_link($subcat, $subcat->taxonomy);
                                    ...
                                    <div class="all-cat-btn">
                                        <a href="<?php echo esc_url($pcat_link); ?>">
                                            <button><?php echo 'All '.esc_html($name); ?> <i aria-hidden="true" class="rt rt-arrow-right-long"></i></button>
                                        </a>
                                    </div>
